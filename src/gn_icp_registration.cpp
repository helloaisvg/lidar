...
GNICPRegistration::PointCloudPtr GNICPRegistration::preprocessPointCloud(const GNICPRegistration::PointCloudPtr& cloud) {
...
void GNICPRegistration::saveRegistrationScreenshot(const PointCloudPtr& source,
                                                  const PointCloudPtr& target,
                                                  const Eigen::Matrix4f& transformation,
    ...
    // 创建可视化器
    pcl::visualization::PCLVisualizer::Ptr viewer(new pcl::visualization::PCLVisualizer("GN-ICP Registration Screenshot"));
    viewer->setBackgroundColor(0, 0, 0);
